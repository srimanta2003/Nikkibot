...
def goodnight_command_handler(_, message):
    ...
    if send_sticker:
        ...
        message.reply_text(f"**gσσ∂ηιgнт, {sender}! ѕℓєєρ тιgнт. 🌙**")
    else:
        emoji = get_random_emoji()
        app.send_message(message.chat.id, emoji)
        message.reply_text(f"**gσσ∂ηιgнт, {sender}! ѕℓєєρ тιgнт. {emoji}**")
...
def get_random_sticker():
    stickers = [
        ...
        "CAACAgUAAx0CcmOuMwACldVlwn9ZHHF2-S-CuMSYabwwtVGC3AACOAkAAoqR2VYDjyK6OOr_Px4E", # sticker 4
        "CAACAgIAAx0Ce9_hCAACaFVlwn-fG58GKoEmmZpVovxEj4PodAACfwwAAqozQUrt2xSTf5Ac4h4E", # sticker 5
    ]
